 ...
 *   Standalone Agents: Rebecca, Iris, Costantino, Giorgio, Pietro, Vito, Valentina
 */
...
export const AGENTS = {
  ...
  giorgio: {
    ...
    secondary: "Data Source Discovery",
  },
  pietro: {
    humanName: "Pietro",
    role: "Data Infrastructure Agent",
  ...
  valentina: {
    humanName: "Valentina",
    role: "Model Defaults Researcher",
    secondary: "Model Defaults Research",
  },
} as const;
...
export const MINIONS = {
  ...
  davi: {
    id: "davi",
    label: "Davi",
    role: "ICP Bracket Classifier",
    description: "Deterministic ICP bracket classifier — assigns the highest-priority bracket to each property using match-rule scoring",
  },
  carlo: {
    id: "carlo",
    label: "Carlo",
